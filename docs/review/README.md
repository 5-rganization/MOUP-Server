...
| 스코프 6 · Q12 | 사장님이 알바생 루틴을 볼 수 있는가? | **제목만. 내용은 안 보인다.** 사장님이 자기 루틴을 알바생 근무에 적용하는 것은 가능 | [정책 6](scope-6-routine-alarm-fcm.md#확정-정책-6--루틴-가시성적용-범위-q12-답변) — 적용 기능은 **신규 개발**이다 |
