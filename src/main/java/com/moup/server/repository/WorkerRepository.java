...
public interface WorkerRepository {
    ...
    void updateLabelColorById(Long id, Long workplaceId, String labelColor);
    ...
    void updateIsAcceptedById(Long id, Long workplaceId, boolean isAccepted);
    ...
    void deleteById(Long id, Long workplaceId);
}
