...
public enum ErrorCode {
    ...
    CANNOT_DELETE_DATA(HttpStatus.BAD_REQUEST, "DELETE_400", "삭제할 수 없는 데이터입니다."),
    ...
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER_404", "해당 유저가 존재하지 않습니다."),
    USER_ALREADY_EXISTS(HttpStatus.CONFLICT, "USER_409", "이미 등록된 유저입니다."),
    WORKPLACE_NOT_FOUND(HttpStatus.NOT_FOUND, "WORKPLACE_404", "해당 근무지(매장)가 존재하지 않습니다."),
    ...
    WORKER_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "WORKER_404", "사용자에 해당하는 근무자가 존재하지 않습니다."),
