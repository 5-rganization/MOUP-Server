...
INSERT INTO works (
    ...
    rest_time_minutes, gross_work_minutes, net_work_minutes,
    memo, hourly_rate, base_pay, night_allowance, holiday_allowance,
    gross_income, estimated_net_income, repeat_days, repeat_end_date
) VALUES
-- 1. 최알바 @ GS25: 9-18시(휴게1시간) -> gross 540분, net 480분
(@wk_choi_gs25, '2025-10-15', '2025-10-15 09:00:00', '2025-10-15 08:58:00', '2025-10-15 18:00:00', '2025-10-15 18:03:00', 60, 540, 480, '월요일 오픈 근무', 10000, 80000, 0, 0, 80000, 77360, NULL, NULL),

-- 2. 이알바 @ 홍콩반점: 14-22시(휴게1시간) -> gross 480분, net 420분
(@wk_lee_hongkong, '2025-10-16', '2025-10-16 14:00:00', '2025-10-16 14:05:00', '2025-10-16 22:00:00', '2025-10-16 22:10:00', 60, 480, 420, '재고 정리', 11000, 77000, 0, 0, 77000, 74490, NULL, NULL),

-- 3. 강알바 @ 메가커피: 10-19시(휴게1시간) -> gross 540분, net 480분
(@wk_kang_mega, '2025-10-17', '2025-10-17 10:00:00', '2025-10-17 10:00:00', '2025-10-17 19:00:00', '2025-10-17 19:00:00', 60, 540, 480, NULL, NULL, 100000, 0, 0, 100000, 96700, NULL, NULL),

-- 4. 최알바 @ 메가커피: 18-23시(휴게30분) -> gross 300분, net 270분 (4.5시간)
(@wk_choi_mega, '2025-10-18', '2025-10-18 18:00:00', '2025-10-18 17:55:00', '2025-10-18 23:00:00', '2025-10-18 23:00:00', 30, 300, 270, '마감 근무', 9860, 44370, 4930, 0, 49300, 47670, NULL, NULL),

-- 5. 이알바 @ 올리브영: 9-15시(휴게30분) -> gross 360분, net 330분 (5.5시간)
(@wk_lee_olive, '2025-10-19', '2025-10-19 09:00:00', '2025-10-19 09:02:00', '2025-10-19 15:00:00', '2025-10-19 15:00:00', 30, 360, 330, '오전 파트타임', 12000, 66000, 0, 0, 66000, 63820, NULL, NULL),

-- 6. 최알바 @ GS25: (1번과 동일) -> gross 540분, net 480분
(@wk_choi_gs25, '2025-10-22', '2025-10-22 09:00:00', '2025-10-22 09:00:00', '2025-10-22 18:00:00', '2025-10-22 18:00:00', 60, 540, 480, '반복 근무 테스트', 10000, 80000, 0, 0, 80000, 77360, 'MONDAY', '2025-11-22 00:00:00'),

-- 7. 이알바 @ 홍콩반점: (2번과 동일) -> gross 480분, net 420분
(@wk_lee_hongkong, '2025-10-23', '2025-10-23 14:00:00', '2025-10-23 14:00:00', '2025-10-23 22:00:00', '2025-10-23 22:00:00', 60, 480, 420, NULL, 11000, 77000, 0, 0, 77000, 74490, 'TUESDAY', '2025-11-23 00:00:00');
