...
-- 6) SALARIES (급여 정책)
-- =====================================
INSERT INTO salaries (worker_id, salary_type, salary_calculation, hourly_rate, fixed_rate, salary_date, salary_day, has_national_pension, has_health_insurance, has_employment_insurance, has_industrial_accident, has_income_tax, has_holiday_allowance, has_night_allowance) VALUES
                                                                                                                                                                                                                                                            (@wk_choi_gs25, 'SALARY_MONTHLY', 'SALARY_CALCULATION_HOURLY', 10000, NULL, 10, NULL, 1, 1, 1, 1, 1, 1, 1),
                                                                                                                                                                                                                                                            (@wk_lee_hongkong, 'SALARY_WEEKLY', 'SALARY_CALCULATION_HOURLY', 11000, NULL, NULL, 'MONDAY', 0, 0, 1, 1, 1, 1, 1),
                                                                                                                                                                                                                                                            (@wk_kang_mega, 'SALARY_MONTHLY', 'SALARY_CALCULATION_FIXED', NULL, 2300000, 25, NULL, 1, 1, 1, 1, 1, 1, 0),
                                                                                                                                                                                                                                                            (@wk_choi_mega, 'SALARY_DAILY', 'SALARY_CALCULATION_HOURLY', 9860, NULL, NULL, NULL, 0, 0, 0, 1, 1, 1, 0),
                                                                                                                                                                                                                                                            (@wk_lee_olive, 'SALARY_MONTHLY', 'SALARY_CALCULATION_HOURLY', 12000, NULL, 15, NULL, 1, 1, 1, 1, 1, 1, 1),
                                                                                                                                                                                                                                                            (@wk_choi_personal, 'SALARY_MONTHLY', 'SALARY_CALCULATION_HOURLY', 10000, NULL, 10, NULL, 1, 1, 1, 1, 1, 1, 1);
...
INSERT INTO works (
    ...
    gross_income, estimated_net_income, repeat_group_id -- ⬅️ [수정] 컬럼 변경
) VALUES
-- 1. 최알바 @ GS25: 9-18시 (야간 0분) -> 'repeat-group-1'
(@wk_choi_gs25, '2025-10-15', '2025-10-15 09:00:00', '2025-10-15 08:58:00', '2025-10-15 18:00:00', '2025-10-15 18:03:00', 60, 540, 480, 0, '월요일 오픈 근무', 10000, 80000, 0, 0, 80000, 77360, 'repeat-group-1'),

-- 2. 이알바 @ 홍콩반점: 14-22시 (야간 0분) -> 'repeat-group-2'
(@wk_lee_hongkong, '2025-10-16', '2025-10-16 14:00:00', '2025-10-16 14:05:00', '2025-10-16 22:00:00', '2025-10-16 22:10:00', 60, 480, 420, 0, '재고 정리', 11000, 77000, 0, 0, 77000, 74490, 'repeat-group-2'),

-- 3. 강알바 @ 메가커피: 10-19시 (야간 0분) -> 단일 근무
(@wk_kang_mega, '2025-10-17', '2025-10-17 10:00:00', '2025-10-17 10:00:00', '2025-10-17 19:00:00', '2025-10-17 19:00:00', 60, 540, 480, 0, NULL, NULL, 100000, 0, 0, 100000, 96700, NULL),

-- 4. 최알바 @ 메가커피: 18-23시 (야간 60분) -> 단일 근무
(@wk_choi_mega, '2025-10-18', '2025-10-18 18:00:00', '2025-10-18 17:55:00', '2025-10-18 23:00:00', '2025-10-18 23:00:00', 30, 300, 270, 60, '마감 근무', 9860, 44370, 4930, 0, 49300, 47670, NULL),

-- 5. 이알바 @ 올리브영: 9-15시 (야간 0분) -> 단일 근무
(@wk_lee_olive, '2025-10-19', '2025-10-19 09:00:00', '2025-10-19 09:02:00', '2025-10-19 15:00:00', '2025-10-19 15:00:00', 30, 360, 330, 0, '오전 파트타임', 12000, 66000, 0, 0, 66000, 63820, NULL),

-- 6. 최알바 @ GS25: (1번과 동일) -> 'repeat-group-1'
(@wk_choi_gs25, '2025-10-22', '2025-10-22 09:00:00', '2025-10-22 09:00:00', '2025-10-22 18:00:00', '2025-10-22 18:00:00', 60, 540, 480, 0, '반복 근무 테스트', 10000, 80000, 0, 0, 80000, 77360, 'repeat-group-1'),

-- 7. 이알바 @ 홍콩반점: (2번과 동일) -> 'repeat-group-2'
(@wk_lee_hongkong, '2025-10-23', '2025-10-23 14:00:00', '2025-10-23 14:00:00', '2025-10-23 22:00:00', '2025-10-23 22:00:00', 60, 480, 420, 0, NULL, 11000, 77000, 0, 0, 77000, 74490, 'repeat-group-2'),

-- 8. 최알바 @ 개인 근무지: 10-12시 (야간 0분) -> 단일 근무 (@wk_choi_personal 변수 사용 가정)
(@wk_choi_personal, '2025-10-20', '2025-10-20 10:00:00', '2025-10-20 10:00:00', '2025-10-20 12:00:00', '2025-10-20 12:00:00', 0, 120, 120, 0, '개인 용무 기록', 10000, 20000, 0, 0, 20000, 19340, NULL);
