...
TRUNCATE TABLE admin_alarm_user_mappings; -- 추가
...
-- `alarm_type` 컬럼 제거 (스키마 변경 사항 반영)
INSERT INTO normal_alarms (sender_id, receiver_id, title, content, sent_at, read_at) VALUES
                                                                                         (@u_kim_owner, @u_choi_worker, '근무 시간 변경 요청', '내일 1시간 일찍 출근 가능할까요?', '2025-09-14 10:00:00', '2025-09-14 10:05:00'),
                                                                                         (@u_park_owner, @u_lee_worker, '급여 지급 완료', '9월 급여가 지급되었습니다. 확인해주세요.', '2025-09-25 11:00:00', NULL),
                                                                                         (@u_choi_worker, @u_kim_owner, '업무 관련 문의', '신제품 재고가 부족합니다.', '2025-09-16 14:30:00', '2025-09-16 14:32:00'),
                                                                                         (@u_kim_owner, @u_kang_worker, 'GS25 역삼점 근무 초대', '안녕하세요 강알바님, GS25 역삼점에서 함께 일하고 싶습니다. 수락하시겠습니까?', '2025-10-01 09:00:00', NULL),
                                                                                         (@u_kang_worker, @u_kim_owner, '근무 초대를 수락했습니다.', '강알바님이 GS25 역삼점 근무 초대를 수락했습니다.', '2025-10-01 11:20:00', '2025-10-01 11:21:00');
...
-- (신규 추가) admin_alarms와 users 연결
INSERT INTO admin_alarm_user_mappings (alarm_id, user_id, read_at, deleted_at) VALUES
-- Alarm 1 (System Check) -> 5명 모두에게 발송
(@admin_alarm_1, @u_kim_owner, '2025-10-15 10:00:00', NULL),
(@admin_alarm_1, @u_park_owner, '2025-10-15 11:00:00', NULL),
...
(@admin_alarm_2, @u_kim_owner, '2025-09-20 10:30:00', NULL),
(@admin_alarm_2, @u_park_owner, '2025-09-20 11:00:00', NULL),
