...
-- (@u_admin, @wp_gs25, '#7FDBFF', '#7FDBFF', 1),    -- (삭제) 관리자는 근무자로 등록 불가
...
(@wk_choi_gs25, '2025-10-15', '2025-10-15 09:00:00', '2025-10-15 08:58:00', '2025-10-15 18:00:00', '2025-10-15 18:03:00', 60, '월요일 오픈 근무', 10000, 80000, 0, 0, 80000, 77360, NULL, NULL),
-- 2. 이알바 @ 홍콩반점: 14-22시(휴게1시간), 시급 11,000원 -> 7시간 * 11,000 = 77,000원
(@wk_lee_hongkong, '2025-10-16', '2025-10-16 14:00:00', '2025-10-16 14:05:00', '2025-10-16 22:00:00', '2025-10-16 22:10:00', 60, '재고 정리', 11000, 77000, 0, 0, 77000, 74490, NULL, NULL),
-- 3. 강알바 @ 메가커피: 월급제 근무자. base_pay, gross_income은 별도 계산된 값으로 가정.
(@wk_kang_mega, '2025-10-17', '2025-10-17 10:00:00', '2025-10-17 10:00:00', '2025-10-17 19:00:00', '2025-10-17 19:00:00', 60, NULL, NULL, 100000, 0, 0, 100000, 96700, NULL, NULL),
...
(@wk_choi_mega, '2025-10-18', '2025-10-18 18:00:00', '2025-10-18 17:55:00', '2025-10-18 23:00:00', '2025-10-18 23:00:00', 30, '마감 근무', 9860, 44370, 4930, 0, 49300, 47670, NULL, NULL),
-- 5. 이알바 @ 올리브영: 9-15시(휴게30분), 시급 12,000원 -> 5.5시간 * 12,000 = 66,000원
(@wk_lee_olive, '2025-10-19', '2025-10-19 09:00:00', '2025-10-19 09:02:00', '2025-10-19 15:00:00', '2025-10-19 15:00:00', 30, '오전 파트타임', 12000, 66000, 0, 0, 66000, 63820, NULL, NULL),
-- 6. 최알바 @ GS25: 반복 근무. 계산은 1번과 동일
(@wk_choi_gs25, '2025-10-22', '2025-10-22 09:00:00', '2025-10-22 09:00:00', '2025-10-22 18:00:00', '2025-10-22 18:00:00', 60, '반복 근무 테스트', 10000, 80000, 0, 0, 80000, 77360, 'MONDAY', '2025-11-22 00:00:00'),
-- 7. 이알바 @ 홍콩반점: 반복 근무. 계산은 2번과 동일
(@wk_lee_hongkong, '2025-10-23', '2025-10-23 14:00:00', '2025-10-23 14:00:00', '2025-10-23 22:00:00', '2025-10-23 22:00:00', 60, NULL, 11000, 77000, 0, 0, 77000, 74490, 'TUESDAY', '2025-11-23 00:00:00');
